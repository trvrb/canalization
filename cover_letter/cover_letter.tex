% topology_cover_letter.tex

\documentclass[stdletter,letterpaper,addrfromright,orderfromdateto,dateleft,11pt,noaddrto]{newlfm}
\topmarginskip{-0.3in}
\bottommarginskip{-0.2in}
\leftmarginsize{1.1in}
\rightmarginsize{1.1in}
\sigskipbefore{0.5in}
\sigskipafter{0in}
\noLines
\nolines
