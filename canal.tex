...
%There is more uncertainty surrounding the mean and variance of antigenic mutations.  If the mean or the variance of mutation effect is lower, then higher rates of antigenic mutation can be tolerated (Figure~\ref{mutationcomp}). 
