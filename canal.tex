...
% Text layout
\usepackage{geometry}
\geometry{textwidth=15.75cm} % 16cm for PLoS
...
\usepackage{multibib}
\newcites{methods,supp}{\large References,\large References}
...
\captionsetup{labelfont=bf,labelsep=period,font=doublespacing,labelformat=number}
